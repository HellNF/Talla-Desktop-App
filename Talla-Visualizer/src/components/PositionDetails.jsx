...
export default function PositionDetails() {
  const { positionDetails } = useGraph();
  return (
    <>
      <div className="flex flex-col mx-5 h-full space-y-4">
        <div className="flex flex-row justify-between">
          <label className="inline-flex flex-col w-full" aria-label="absolute time">
            <span className="ml-2 font-semibold">abs_time:</span>
            <span className="ml-2 font-normal">{positionDetails?.abs_time}</span>
          </label>
        </div>
        ...
        <div className="flex flex-row justify-between space-x-4">
          ...
          <label className="inline-flex flex-col w-full" aria-label="trace area">
            <span className="ml-2 font-semibold">trace_area:</span>
            <span className="ml-2 font-normal">{positionDetails?.trace_area}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between space-x-4">
        ...
        <div className="flex flex-row justify-between space-x-4">
          <label className="inline-flex flex-col w-full" aria-label="number of anchors">
            <span className="ml-2 font-semibold">num_anchors:</span>
            <span className="ml-2 font-normal">{positionDetails?.num_anchors}</span>
          </label>
          <label className="inline-flex flex-col w-full" aria-label="anchor synchronization">
            <span className="ml-2 font-semibold">anchor_synch:</span>
            <span className="ml-2 font-normal">{positionDetails?.anchor_synch}</span>
          </label>
          <label className="inline-flex flex-col w-full" aria-label="anchor reference">
            <span className="ml-2 font-semibold">anchor_ref:</span>
            <span className="ml-2 font-normal">{positionDetails?.anchor_ref}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between">
          <label className="inline-flex flex-col w-full" aria-label="anchor receiver">
            <span className="ml-2 font-semibold">anchor_rec:</span>
            <span className="ml-2 font-normal">{positionDetails?.anchor_rec}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between space-x-4">
          <label className="inline-flex flex-col w-full" aria-label="synchronization epoch">
            <span className="ml-2 font-semibold">synch_epoch:</span>
            <span className="ml-2 font-normal">{positionDetails?.synch_epoch}</span>
          </label>
          <label className="inline-flex flex-col w-full" aria-label="synchronization slot">
            <span className="ml-2 font-semibold">synch_slot:</span>
            <span className="ml-2 font-normal">{positionDetails?.synch_slot}</span>
          </label>
          <label className="inline-flex flex-col w-full" aria-label="server poll delay">
            <span className="ml-2 font-semibold">server_poll_delay:</span>
            <span className="ml-2 font-normal">{positionDetails?.server_poll_delay}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between">
          <label className="inline-flex flex-col w-full" aria-label="tdoa distance">
            <span className="ml-2 font-semibold">tdoa_dist:</span>
            <span className="ml-2 font-normal">{positionDetails?.tdoa_dist}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between space-x-4">
          <label className="inline-flex flex-col w-full" aria-label="reference receiver power">
            <span className="ml-2 font-semibold">ref_rxpwr:</span>
            <span className="ml-2 font-normal">{positionDetails?.ref_rxpwr}</span>
          </label>
          <label className="inline-flex flex-col w-full" aria-label="reference fp power">
            <span className="ml-2 font-semibold">ref_fppwr:</span>
            <span className="ml-2 font-normal">{positionDetails?.ref_fppwr}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between">
          <label className="inline-flex flex-col w-full" aria-label="receivers receiver power">
            <span className="ml-2 font-semibold">receivers_rxpwr:</span>
            <span className="ml-2 font-normal">{positionDetails?.receivers_rxpwr}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between">
          <label className="inline-flex flex-col w-full" aria-label="receivers fp power">
            <span className="ml-2 font-semibold">receivers_fppwr:</span>
            <span className="ml-2 font-normal">{positionDetails?.receivers_fppwr}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between space-x-4">
          <label className="inline-flex flex-col w-full" aria-label="initial location">
            <span className="ml-2 font-semibold">initial_loc:</span>
            <span className="ml-2 font-normal">{positionDetails?.initial_loc}</span>
          </label>
        ...
        <div className="flex flex-row justify-between">
          <label className="inline-flex flex-col w-full" aria-label="residuals">
            <span className="ml-2 font-semibold">residuals:</span>
            <span className="ml-2 font-normal">{positionDetails?.residuals}</span>
          </label>
        </div>
        <div className="flex flex-row justify-between space-x-4">
